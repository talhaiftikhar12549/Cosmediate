...
export default function SideBar() {
    return (
        <>
            <section className=" fixed flex flex-row">

                {/* left Space Bar */}
                <div className="bg-[#F9F9FB] h-[100vh] w-[10px]">
                </div>
                {/* left Space Bar */}

                {/* SideBar */}
                <div className="bg-[#F9F9FB] w-[106px] h-[100vh] flex flex-col items-center">
                    {/* Nav Items */}
                    <div className=" w-[100%] flex-none">
                        ...
                        <div className="flex flex-col items-center cursor-pointer py-4 relative">
                        ...
                        <div className="flex flex-col items-center cursor-pointer bg-[#ffffff] py-4 rounded-l-2xl">
                    ...
                    {/* Log Out  */}
                    <div className=" w-[100%] relative flex flex-col justify-around h-[100%] ">
                        <div  >
